...
def import_profile(
    ...
    try:
        ...
        identity = build_fingerprint_identity(
            ...
            behavior=behavior,
            overrides={
                "gpu_vendor": portable.gpu_vendor,
                "gpu_renderer": portable.gpu_renderer,
                "hardware_concurrency": portable.hardware_concurrency,
                "device_memory": portable.device_memory,
                "screen_width": portable.screen_width,
                "screen_height": portable.screen_height,
                "brand": portable.brand,
            },
        )
        profile = Profile(
            id=str(uuid4()),
