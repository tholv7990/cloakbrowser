...
public static class CloakLauncher
{
        ...
        bool startMaximized = false)
    {
        ...
        if (fingerprintPreset == FingerprintPreset.Consistent)
        {
            Set("--fingerprint-noise", "--fingerprint-noise=false");
            if (persistent)
                Set("--fingerprint-storage-quota", "--fingerprint-storage-quota=10240");
        }
